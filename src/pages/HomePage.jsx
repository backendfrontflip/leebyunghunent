    ...
    <div className="min-h-screen flex flex-col items-center justify-center text-white">
      ...
      {showAnnouncement && (
        <div className="fixed top-4 left-1/2 transform -translate-x-1/2 bg-yellow-400 text-black px-6 py-3 rounded-full shadow-lg z-50 animate-bounce flex flex-col text-center">
          ...
          <Link to="/tickets" className="underline font-semibold">Click here</Link>
      ...
      <div className="px-4 py-8 w-full">
        ...
        <div className="bg-black text-white p-6 rounded-2xl shadow-lg max-w-4xl w-full mx-auto mt-10 text-center border border-pink-500">
          ...
          <p className="mb-4 text-base sm:text-lg">
            Secure your spot at the <span className="font-bold">Squid Game Parade Finale Fan Event</span> happening on <strong>June 28, 2025 at 19:30 KST</strong>!
          </p>

          <p className="mb-4 text-sm sm:text-md text-yellow-300 font-semibold">
            ✈️ Each ticket includes a fully paid flight to the premiere and an exclusive pre-show interaction with the main cast!
          </p>

          <p className="mb-6 text-base">
            Mingle with stars like <strong>Lee Byung-hun</strong>, <strong>Jung Ho-yeon</strong>, and <strong>Wi Ha-jun</strong> before the event begins. This once-in-a-lifetime experience is limited to VIP attendees only!
          </p>

          <Link to="/ticket" className="inline-block w-full sm:w-auto">
      ...
      <article className="reveal bg-red-900 text-white py-12 px-6 rounded-2xl m-4 shadow-lg max-w-4xl text-center">
        <div className='flex flex-col'>
          ...
          <div className='flex justify-center mb-4'>
            <strong className='text-2xl text-black rounded-3xl border-transparent w-60 bg-white p-2'>Squid Game Movie North America Tour OnGoing!</strong>
          </div>
        </div>
        <div className='flex flex-col'>
